    ...
    <div className="min-h-screen bg-[#0A0A0A] flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-[#111] border border-neutral-800 rounded-2xl p-7 shadow-2xl">
          ...
          <p className="text-sm text-white/40 mb-7">Acesso completo ao Vertex OS.</p>
          ...
          <div className="mt-6 pt-5 border-t border-neutral-800 text-center">
            <span className="text-sm text-white/40">Já tem conta?{" "}</span>
            <a href="/login" className="text-sm text-indigo-400 hover:text-indigo-300 font-medium transition-colors">
              Entrar
            </a>
          </div>
        </div>
